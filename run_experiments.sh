...
# 可选项: mymodel,vcaan,locf,knn,mice,saits,itransformer,grud,usgan
MODELS="mymodel,locf,knn,itransformer"
...
# 9. 运行模式 (支持外部传入命令参数，例如 ./run_experiments.sh train)
...
echo "=========================================================="
echo "✅ 跑批完毕！"
echo "你可以前往 logs/${RUN_NAME} 查看日志、可视化图表及 summary_all_parts.csv 汇总数据！"
echo "=========================================================="
